var checkout_complete = (payment_type) => {
  ...
  adebis.innerHTML = "<img src='https://ac.ebis.ne.jp/log.php?argument=MsNhvGYE"
    + "&referrer=" + encodeURIComponent(document.referrer) + "&"
    + "width=" + screen.width + "&"
    + "height=" + screen.height + "&"
    + "ebisPageID=complete&"
    + "ebisOther1=" + project_title_ + "&"
    + "ebisOther2=" + item_name_ + "&"
    + "ebisOther3=" + payment_type_ + "&"
    + "ebisOther4=&"
    + "ebisOther5=&"
    + "ebisMember=" + member_id + "&"
    + "ebisAmount=" + price_ + "&"
    + "color=" + screen.colorDepth + "' width='0' height='0'>";
